...
<body>
  <div>
    <nav class="navbar navbar-expand-lg bg-body-tertiary bg-dark" data-bs-theme="dark">
      <div class="container-fluid">
        <a class="navbar-brand" href="../avaliacoes/avaliacoes_coordenador.php">Início</a>
  ...
  <div class="d-flex justify-content-center pt-2">
    ...
    <a href="avaliacoes_usuarios_coordenadores.php?id_tipo=null&idusuario=null&id_data=null" class="btn btn-secondary btn-lg m-2">Editor e Avaliação Por Usuário</a>
    <a href="avaliacoes_nao_realizadas_coordenadores.php?id_data=6&id_data=null&modo=null" class="btn btn-outline-secondary btn-lg m-2">Usuários Pendentes</a>
  ...
  <div class="container py-2">
    <form action="avaliacoes_usuarios_coordenadores.php" method="GET">
    <div>
    <input name="id_tipo" value="6" type="hidden" id="id_tipo" checked require>
      ...
      <div class="mb-3">
        ...
        <select class="form-select" name="idusuario" id="idusuario" required>
          ...
          $editar_usuarios = "SELECT * FROM usuario where situacao = 1 and avaliador = $id_login order by nomecompleto ASC"; 
...
FROM avaliacoes a
WHERE idusuario = $idusuario and data = $id_data
";
...
$idsupervisor = 0;
$idusuario_a = 0;
echo "Pressione enviar ou não há registros para esta data.</div>";
}
